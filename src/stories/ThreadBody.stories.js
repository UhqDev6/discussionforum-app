...
import ThreadBody from '../components/atoms/ThreadBody';
...
function TemplateStory(args) {
  return <ThreadBody {...args} />;
}

const withThreadBodyOnDetailThread = TemplateStory.bind({});
withThreadBodyOnDetailThread.args = {
...
export { withThreadBodyOnDetailThread };
